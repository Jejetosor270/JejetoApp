...
export const budgetReviewColumnLabels = {
  ...
  quantity: "Qty",
  unitOfMeasure: "Unit",
  unitPurchasePriceHt: "Budget Purchase Unit HT",
  totalPurchasePriceHt: "Budget Purchase Total HT",
  unitSellingPriceHt: "Budget Unit HT",
  totalSellingPriceHt: "Budget Total HT",
  markupRate: "Markup %",
  vatRate: "VAT %",
...
export const budgetReviewVisibleColumns = [
  ...
  "Qty",
  "Unit",
  "Budget Purchase Unit HT",
  "Budget Purchase Total HT",
  "Budget Unit HT",
  "Budget Total HT",
  "Markup %",
  "VAT %",
